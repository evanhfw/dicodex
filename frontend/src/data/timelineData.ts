...
const aiMilestones: TimelineMilestone[] = [
  ...
  // Week 2 — ILT 1
  { date: new Date('2026-02-23'), label: 'Tech ILT 1: AI - Understanding the Basics of Python Programming', type: 'event' },
  ...
  { date: new Date('2026-03-09'), label: 'Tech ILT 2: AI - Intro to Supervised Learning', type: 'event' },
  ...
  // Week 7
  { date: new Date('2026-03-30'), label: 'Tech ILT 3: AI - Unsupervised Learning', type: 'event' },
  ...
  // Week 11 — Tech ILT 4
  { date: new Date('2026-04-27'), label: 'Tech ILT 4: AI - Deep Learning, Computer Vision & Time Series', type: 'event' },
  ...
  // Week 13 — Tech ILT 5
  { date: new Date('2026-05-11'), label: 'Tech ILT 5: AI - Game Changer: NLP & Generative AI', type: 'event' },
  ...
  // Week 15 — Tech ILT 6
  { date: new Date('2026-05-25'), label: 'Tech ILT 6: AI - Beyond the Template: Building Flexible Models', type: 'event' },
  ...
  { date: new Date('2026-06-01'), label: 'Tech ILT 7: AI - Building Time Series Prediction Models', type: 'event' },
...
const fcMilestones: TimelineMilestone[] = [
  ...
  // Week 2 — Tech ILT 1
  { date: new Date('2026-02-23'), label: 'Tech ILT 1: FS - Front-End Basics: Building Your First Web Application', type: 'event' },
  { date: new Date('2026-03-01'), label: 'Assignment SS 1 Deadline', type: 'deadline' },
  ...
  // Week 4
  { date: new Date('2026-03-09'), label: '[Wajib] Financial Literacy #1', type: 'event' },
  { date: new Date('2026-03-09'), label: 'Tech ILT 2: FS - Interactive Web: Introduction to DOM Manipulation', type: 'event' },
  { date: new Date('2026-03-15'), label: 'Assignment SS 2 Deadline', type: 'deadline' },
  ...
  // Week 8
  { date: new Date('2026-04-06'), label: '[Wajib] Team Meeting #1', type: 'event' },
  { date: new Date('2026-04-06'), label: 'Tech ILT 3: FS - React 101: Building Your First React Application', type: 'event' },
  ...
  // Week 10 — Tech ILT 4
  { date: new Date('2026-04-20'), label: 'Tech ILT 4: FS - Back-End Integration: Asynchronous JavaScript Requests & Fetch', type: 'event' },
  { date: new Date('2026-04-26'), label: 'Assignment SS 4 Deadline', type: 'deadline' },
  ...
  // Week 12
  { date: new Date('2026-05-04'), label: 'Tech ILT 5: FS - Backend Essentials: Intro to Server-Side Programming with Node.js', type: 'event' },
  { date: new Date('2026-05-10'), label: 'Assignment SS 5 Deadline', type: 'deadline' },
  ...
  // Week 14
  { date: new Date('2026-05-18'), label: 'Tech ILT 6: FS - From REST to AI: Bringing Intelligence to Your Back-End', type: 'event' },
  { date: new Date('2026-05-24'), label: 'Assignment SS 6 Deadline', type: 'deadline' },
  ...
  // Week 16
  { date: new Date('2026-06-01'), label: 'Tech ILT 7: FS - Behind the Scenes: How Applications Identify and Control Users', type: 'event' },
  { date: new Date('2026-06-07'), label: 'Assignment SS 7 Deadline', type: 'deadline' },
